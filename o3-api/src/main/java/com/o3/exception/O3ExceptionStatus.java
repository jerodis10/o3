...
public enum O3ExceptionStatus {
    ...
    NO_JSON_EXTERNAL_API("STA_2410", "외부 API 연동시 데이터를 가져오지 못했습니다."),
    NO_SALARY_EXTERNAL_API("STA_2420", "외부 API 연동시 급여 리스트를 가져오지 못했습니다."),
    NO_INCOME_EXTERNAL_API("STA_2430", "외부 API 연동시 소득공제 리스트를 가져오지 못했습니다.")
    ;
