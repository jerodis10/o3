...
class HostNameCircuitBreakerNameResolverTest {
    ...
    public static List<Arguments> circuitBreakerName() {
        return Arrays.asList(
                ...
                Arguments.of("https://google.com/search?name=feign", "google.com"),
                Arguments.of("http://www.naver.com/search?name=feign&key=feign", "www.naver.com"),
                Arguments.of("http://google.com/search?name=feign", "google.com"),
